<template>
  <div>
    ...
    <div class="saoma" v-show="issaoma">
      <h3 style="text-align: center">请使用狼小宝APP扫码登录</h3>
      <div class="qrcode" ref="qrCodeUrl">
        <!-- <image style="position: absolute; top: 50%; left: 50%">得到</image> -->
        <!-- <img
          src="../../../assets/img/waoku.jpg"
          style="
            width: 60px;
            height: 60px;
            position: absolute;
          ...
          alt=""
        /> -->
        <div class="guoqi" v-if="status == 2" @click="freshcode">
          <img src="../../../assets/img/fresh.png" alt="" />
        </div>
      </div>
      <h5 style="text-align: center; margin-top: 10px" v-show="status == 2">
        二维码已过期，请刷新
      </h5>

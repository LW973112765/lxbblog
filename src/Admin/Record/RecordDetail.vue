<template>
    <div class="user">
		...
		<div v-print="_page"><img width="50px" height="50px" src="./1.png"  alt="">导出为pdf(全局)</div>
		<div  @click="downloadHtmlToPdf(data.name)"><img width="50px" height="50px" src="./2.png" alt="">导出为pdf(部分)</div>
	</div>
        <div id="_page"
